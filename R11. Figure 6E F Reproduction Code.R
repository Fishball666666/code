...
data_file      <- "2021_YLDs.csv"  # Your data file
save_main_name <- "Top1_Risk_Factor_World_Map_2021_YLDs"    # Output file name prefix

unique(top1_data$rei_name)

my_colors <- c(
  "Iron deficiency" = "#FCBF49",             
  "Diet high in processed meat" = "#9381FF" ,
  "Diet low in whole grains" = "#6db0ff"   
...
ggsave(
  ...
  plot = main_map,
  device = "pdf",
  width = 14,  # Adjust size according to journal requirements
  height = 7,
  units = "in"
)
